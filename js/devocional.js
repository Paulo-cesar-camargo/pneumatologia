...
const respostasFixas = {
  ...
  11:{a1:"Revela a Pedro que o Evangelho é também para os gentios, mostrando que Deus aceita todos os povos.", 
      a2:"Não devemos ter preconceitos entre raça linga etinia generos e levar a palavra de deus e seu amor a todos ", 
      a3:"Buscar ser sensivel à voz do Espírito, mesmo quando Ele nos desafia a mudarmos a nos mesmos antes dos outros."},
  12:{a1:"Sustentando a igreja em oração e liberta Pedro milagrosamente da prisão, mostrando que nada pode impedir o plano de Deus.", 
      a2:"A orarmos unidos pois a oração do justo pode muito em seus efeitos e o espirito santo age de formas misteriosas", 
      a3:"Orar com fé e confiar que o Espírito trabalha mesmo quando não vemos ele age ni silencio."},
  13:{a1:"Chama Barnabé e Saulo/Paulo para a missão e os envia a pregar o Evangelho com poder.", 
      a2:"Compreender que o Espírito Santo ainda chama e capacita pessoas para levar Cristo ao mundo", 
      a3:"Separar tempo para orar e ouvir a direção do Espírito"},
  14:{a1:"Fortalecendo os missionários, confirmando o Evangelho com milagres e encorajando os novos crentes na fé.", 
      a2:"Confiar de o espírito santo nos dar força em meio às lutas.", 
      a3:"Permanecer firme e sensível à voz do Espírito, mesmo nas dificuldades."},
  15:{a1:"Guiando a Igreja a decidir com sabedoria sobre a lei e a liberdade em Cristo.", 
      a2:"Acreditar que o espírito santo nos traz clareza e evita divisões quando o buscamos de todo nosso coração.", 
      a3:"Ouvir a Palavra e buscar o consenso conselhos com meus pastores"},
  16:{a1:"Direcionando Paulo para Macedônia, abrindo novas portas para o Evangelho e impedindp Paulo de ir a outros lugares.", 
      a2:"Andar na direção de Deus é com certesa a melhor escolha porque nem sempre o NÃO de Deus é negativo", 
      a3:"Aceitando os planos do Espírito mesmo que sejam diferentes dos nossos."},
  17:{a1:"Dando sabedoria a Paulo para pregar de forma intendivel aos gregos e aos filósofos.", 
      a2:"Aprender a comunicar o Evangelho de forma relevante em qualquer ambiente.", 
      a3:"Pedir discernimento ao Espírito para agir com sabedoria e respeito."},
  18:{a1:"Fortalecendo Paulo diante da oposição e das dificuldades e o encorajando a continuar pregando.", 
      a2:"Acreditar que o espírito santo nos sustenta quando estamos cansados e com medo de seguir.", 
      a3:"Buscar consolo e direção do Espírito em momentos de desânimo."},
  19:{a1:"Batizando os crentes em Éfeso e manifestando o poder através de milagres e libertações.", 
      a2:"?", 
      a3:"Viver cheio do Espírito, permitindo que Ele renove e conduza minhas ações."},
